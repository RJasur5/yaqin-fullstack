...
void main() async {
  ...
  // Initialize Firebase FIRST (required for iOS with explicit options)
  try {
    if (Platform.isIOS) {
    ...
    debugPrint('Firebase pre-init (iOS): $e');
  }
...
void onStart(ServiceInstance service) async {
  ...
  try {
    final apiService = ApiService();
    final authService = AuthService(apiService);
    await NotificationService().init(requestPermission: false, authService: authService, isBackgroundService: true);
